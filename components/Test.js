            ...
            <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
              ...
              <div className="pt-5 pb-6">
                <div className="px-2 space-y-1">
                  <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">ブランド紹介</a>
                  <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">商品一覧</a>
                  <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">お問い合わせ</a>
                ...
                <div className="mt-6 px-5">
                  <p className="text-center text-base font-medium text-gray-500">もっと詳しくは　<a href="#" className="text-gray-900 hover:underline">ログイン</a></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <main>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    <a href="#" className="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                      <span className="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full">全国送料無料</span>
                    ...
                    <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      <span className="block">植物用LED専門店</span>
                      <span className="block text-red-700">天狗ライト</span>
                    </h1>
                    <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      アメリカで一番流行ってる最先端のLEDライトを、送料なし、関税なし、配送代行なし！最安価格で購入できる日本一の植物用LED専門店です。
                    </p>
                    <div className="mt-10 sm:mt-12">
                      <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                        
                        <p className="mt-3 text-sm text-gray-300 sm:mt-4">7日以内安心返品保証 ＆ 3年間の品質保証 <a href="#" className="font-medium text-white">　ポリシーを見る</a>.</p>
                      </form>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
            <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
              <div>
                <h2 className="text-base font-semibold tracking-wider text-red-700 uppercase">栽培業界トップ</h2>
                <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                  取り扱いしているブランドをご紹介します
                </p>
                <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                  アメリカのAmazonでは☆5のレビューが各製品別に約2,000件以上！初心者向けの小さいライトからプロ用の高級モデルまで。安定のMARS HYDROと呼ばれています。そして、アメリカやオーストラリアの若い人たちの間で大人気のSPIDER FARMERも入荷中！軽くて洗練されたデザイン。今までのライトの中で一番シンプルな見た目ですが、性能はバッチリのちょっぴり高級ライン。
                </p>
              </div>
                  ...
                  <div className="pt-6">
                    <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                      <div className="-mt-6">
                        ...
                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">調光機能付き</h3>
                        <p className="mt-5 text-base text-gray-500">
                          成長ステージに合わせて簡単に調節できます。成長期や開花期に合わせて光の量を増やしたり、季節や天気によって調節したり。とても簡単！
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-6">
                    <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                      <div className="-mt-6">
                        ...
                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">収穫量が増大</h3>
                        <p className="mt-5 text-base text-gray-500">
                         室内栽培で何かを収穫している方は注目！天狗ライトの商品は植物マニアのスタッフたちも全員個人で所有しています！桁違いの収穫量をご約束します。
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="pt-6">
                    <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                      <div className="-mt-6">
                        ...
                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">0ノイズ構造</h3>
                        <p className="mt-5 text-base text-gray-500">
                          ファンレスってご存知ですか？クーリング用のファンをなくして本体自体が熱調節を行うことにより、とても静かなお部屋栽培が可能になりますた。
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <blockquote>
                    <div>
                      ...
                      <p className="mt-6 text-2xl font-medium text-white">
                        驚きの明るさにとてもびっくりしました。Amazonのレビューがすごくよかったので購入してみましたのですが、これは本当に素晴らしいライトです。つけたらすぐその変化が分かると思います。私はTS600を2台購入しましたが、あともう一つ注文しようっと考え中です。
                      </p>
                    </div>
