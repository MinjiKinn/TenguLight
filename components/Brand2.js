...
<div className="relative z-20 w-full flex flex-wrap justify-around items-center max-w-4xl md:justify-items-center">
  <div className="w-full md:w-64">
    <div className="relative mb-10">
    <Image
    src="/img/56211.jpg"
    width={256}
    height={256}  className="w-64 h-64 object-center md:absolute flex justify-center items-start" />
  ...
  <div className="w-full md:w-64 md:mt-32">
    ...
    <h3 className="text-lg uppercase tracking-tighter text-center font-sans">3.3年間の品質保証</h3>
  </div>
</div>
